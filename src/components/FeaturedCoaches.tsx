      ...
      <div className="container mx-auto px-4">
        ...
        >
          {coaches.map((coach, index) => (
            <div
              key={index}
              className="flex-shrink-0 w-[300px] md:w-[320px] bg-card rounded-xl p-5 border border-border/40 group cursor-pointer transition-all duration-300 hover:border-border hover:scale-[1.02] hover:shadow-lg flex flex-col"
