      ...
      <div className="w-full max-w-md text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-[#888] font-light mt-2 leading-relaxed">
            This portal is only available to customers who have purchased access to this masterclass.
...
export default function GeneralPortalLayout() {
  ...
  if (user.email?.toLowerCase() !== "demo@earlyedge.co.uk") {
    return <Navigate to="/dashboard" replace />;
  }

  // NOTE: For debugging / generating generically, we temporarily disable the buyer block
