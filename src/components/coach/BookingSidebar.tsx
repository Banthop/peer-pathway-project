  ...
  return (
    <div className="bg-card border border-border rounded-xl p-5 space-y-5">
      ...
      <div className="space-y-3">
        <Button className="w-full font-sans font-light bg-foreground text-background hover:bg-foreground/90">
          Schedule a free intro
        </Button>
        <Button variant="outline" className="w-full font-sans font-light">
          Book a session
        </Button>
      </div>
