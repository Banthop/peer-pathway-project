...
import {
    ...
    Users, Eye, DollarSign, MessageSquare, ExternalLink,
} from "lucide-react";
import {
    coachStats, upcomingCoachSessions, pastCoachSessions,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8">
                ...
                <div className="space-y-6 min-w-0">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                        <StatCard label="Earnings" value={coachStats.totalEarningsThisMonth.toLocaleString()} change={coachStats.earningsChange} icon={DollarSign} prefix="£" />
                        <StatCard label="Sessions" value={coachStats.sessionsThisMonth} change={coachStats.sessionsChange} icon={Calendar} />
                        <StatCard label="Rating" value={coachStats.averageRating} icon={Star} />
                        <StatCard label="Profile Views" value={coachStats.profileViews} change={coachStats.viewsChange} icon={Eye} />
                    </div>
                    ...
                    <div>
                        ...
                        {upcomingCoachSessions.filter((s) => !s.isNext).slice(0, 2).map((session) => (
                            <div
                                key={session.id}
                                ...
                                <div className="flex items-center gap-3 text-xs ml-12 sm:ml-0">
                                    ...
                                    {session.hasMessage && (
                                        <span className="flex items-center gap-1.5 text-muted-foreground">
                                            <MessageSquare className="w-3 h-3" /> 1 new
                                        </span>
                                    )}
                                </div>
                            </div>
